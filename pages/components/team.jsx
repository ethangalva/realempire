    ...
    return (
        <div className="h-screen flex flex-col md:px-8 md:py-6 snap-center gap-4 bg-customBlack" id="team">
            <div className="flex flex-col h-full gap-4 p-4 bg-customGreen md:justify-center md:rounded-3xl overflow-hidden md:h-full ">
                <h1 className="text-white text-2xl font-bold text-center">Our Team</h1>
                {/* TEAM MEMBERS */}
                <div className="w-full h-full flex flex-wrap md:flex-nowrap md:h-2/3">
                    {/* single container of team member */}
                    <div className="h-1/2 w-1/2 p-4 pb-2 pr-2 md:py-0 md:px-2 md:h-full">
                        <div className="flex flex-col h-full w-full gap-2">
                            <div className="w-full h-1/2  rounded-3xl bg-[url('../public/images/person-1.jpg')] bg-top bg-no-repeat bg-cover" />
                    ...
                    <div className="h-1/2 w-1/2  p-4 pb-2 pl-2 md:py-0 md:px-2 md:h-full">
                        <div className="flex flex-col h-full w-full gap-2">
                            <div className="w-full h-1/2  rounded-3xl bg-[url('../public/images/person-2.jpg')] bg-top bg-no-repeat bg-cover" />
                            <div className="w-full h-1/2 flex flex-col items-center gap-2">
                    ...
                    <div className="h-1/2 w-1/2  p-4 pt-2 pr-2 md:py-0 md:px-2 md:h-full">
                        <div className="flex flex-col h-full w-full gap-2">
                            <div className="w-full h-1/2  rounded-3xl bg-[url('../public/images/person-3.jpg')] bg-top bg-no-repeat bg-cover" />
                            <div className="w-full h-1/2 flex flex-col items-center gap-2">
                    ...
                    <div className="h-1/2 w-1/2  p-4 pt-2 pl-2 md:py-0 md:px-2 md:h-full">
                        <div className="flex flex-col h-full w-full gap-2">
                            <div className="w-full h-1/2  rounded-3xl bg-[url('../public/images/person-4.jpg')] bg-top bg-no-repeat bg-cover" />
                            <div className="w-full h-1/2 flex flex-col items-center gap-2">
