    ...
    return (
        <div className="h-screen flex flex-col p-4 md:px-8 md:py-6 snap-center justify-between bg-customBlack" id="contact">
            ...
            <div className="w-full flex flex-row">
                ...
                <div className="text-white hidden md:block text-center w-1/3">
                    BASED IN USA<br />
                    WORKING WORLDWIDE
                </div>
                <div className="w-1/2 items-center flex justify-end gap-2 text-white font-bold  md:w-1/3">
            ...
            {/* CALL TO ACTION */}
            <div className="w-full text-center font-bold text-5xl md:text-8xl text-white hover:underline">
